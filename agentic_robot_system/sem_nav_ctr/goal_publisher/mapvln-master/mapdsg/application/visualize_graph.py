...
def main(params: DictConfig):
    ...
    for room_id, room_centroid_viz in room_centroids_viz.items():
        p.add_mesh(pv.Sphere(center=tuple(room_centroid_viz), radius=0.15), color="blue")
    #     p.add_mesh(
    ...
    for obj_id, obj_info in object_infos.items():
        if (
            ...
            if object_name in ["divider", "ledge", "pillar", "tape", "stairs", "door", "doors", "stair", "window", "glass", 
